...
Very slightly modified training code from [@nshepperd](https://github.com/nshepperd/gpt-2). Added support for simple early stopping and training for a pre-set number of iterations (see src/train.py).

# Original @nshepperd README
